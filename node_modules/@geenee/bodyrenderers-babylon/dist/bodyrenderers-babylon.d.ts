import { SceneRenderer, CanvasMode, ScenePlugin, Size, Renderer, VideoPlugin, ShaderProgram, ShaderPlugin, ImageTexture } from '@geenee/armature';
import { PoseResult, FaceResult, PosePoints } from '@geenee/bodyprocessors';
import * as babylon from '@babylonjs/core';
import { Coord3D, Coord2D, PosePoint } from '@geenee/bodytracking';
...
declare type Skeleton = SkeletonMap<BoneTransform>;
/** Skeleton - bones of the rig */
declare type SkeletonRef = SkeletonMap<babylon.TransformNode>;
/** Shape of spine
 *
...
declare class PoseAlignPlugin extends PosePlugin {
    ...
    protected skeletonRef?: babylon.Skeleton;
    /** Shape of spine */
 ...
 * Body patch plugin
 *
 * Plugin patches/inpaints/erases foreground region
 * of image defined by body segmentation mask from
 * {@link @geenee/bodyprocessors!PoseProcessor}.
 * It can be used in avatar virtual try to remove
 * parts of a body that stick out (not covered).
 * Evaluation of body segmentation must be enabled in
 * {@link @geenee/bodyprocessors!PoseProcessor#init}
 * ({@link @geenee/bodyprocessors!PoseParams#mask}).
 */
...
export { BabylonPlugin, BabylonRenderer, BabylonUniRenderer, BodyPatchPlugin, BodypartPatchPlugin, BoneList, BoneName, BoneTransform, FaceDebugPlugin, FaceMaskPlugin, FacePlugin, FaceRenderer, FaceTrackPlugin, HeadTrackPlugin, OccluderPlugin, OutfitParams, PoseAlignPlugin, PoseDebugPlugin, PoseOutfitPlugin, PosePlugin, PoseRenderer, PoseTuneParams, PoseTwinPlugin, Skeleton, SkeletonMap, mapSkeleton };
