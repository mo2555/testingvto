...
declare type PoseMask = NonNullable<PoseDetection["mask"]>;
declare type PoseDebug = NonNullable<PoseDetection["debug"]>;
/** Pose detection */
interface Pose {
    /**
...
export { Face, FaceEngine, FaceParams, FaceProcessor, FaceResult, Pose, PoseEngine, PoseParams, PosePoints, PoseProcessor, PoseResult };
